"""SBS packer armed only by hotkey/flag — no time>N (that gets optimised out)."""
...
[KeyEnableUpscale]
; Press after you are in-world to arm SBS packer
...
print("OK key-armed packer (F8). No UnbindAll.")
